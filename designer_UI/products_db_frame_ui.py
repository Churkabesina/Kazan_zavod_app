...
class Ui_products_db_frame(object):
    def setupUi(self, products_db_frame):
        ...
        self.add_product_db_button = QPushButton(products_db_frame)
        self.add_product_db_button.setObjectName(u"add_product_db_button")
        sizePolicy.setHeightForWidth(self.add_product_db_button.sizePolicy().hasHeightForWidth())
        self.add_product_db_button.setSizePolicy(sizePolicy)

        self.buttons_layout.addWidget(self.add_product_db_button)

        self.del_product_db_button = QPushButton(products_db_frame)
        self.del_product_db_button.setObjectName(u"del_product_db_button")
        sizePolicy.setHeightForWidth(self.del_product_db_button.sizePolicy().hasHeightForWidth())
        self.del_product_db_button.setSizePolicy(sizePolicy)

        self.buttons_layout.addWidget(self.del_product_db_button)
    ...
    def retranslateUi(self, products_db_frame):
        ...
        self.add_product_db_button.setText(QCoreApplication.translate("products_db_frame", u"\u0414\u043e\u0431\u0430\u0432\u0438\u0442\u044c \u043f\u0440\u043e\u0434\u0443\u043a\u0446\u0438\u044e", None))
        self.del_product_db_button.setText(QCoreApplication.translate("products_db_frame", u"\u0423\u0434\u0430\u043b\u0438\u0442\u044c \u043f\u0440\u043e\u0434\u0443\u043a\u0446\u0438\u044e", None))
